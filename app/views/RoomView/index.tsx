...
import { InteractionManager, PixelRatio, Text, View, ImageBackground } from 'react-native';
...
class RoomView extends React.Component<IRoomViewProps, IRoomViewState> {
	...
	render() {
		...
		const { user, baseUrl, theme, width, serverVersion, sortPreferences, navigation, encryptionEnabled } = this.props;
		const { rid, t } = room;
		let bannerClosed;
		let announcement;
		if ('id' in room) {
